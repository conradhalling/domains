...
def process_file(filename, tld):
    ...
    # For my purposes, a URL ends with ":", "/", or "?", or exhausts the string, which is
    # terminated with '"'.
...
def main():
    ...
    # .info
    tld = ".info"
    for filename in ('data/cdx/cdx-00200.gz', 'data/cdx/cdx-00201.gz', 'data/cdx/cdx-00202.gz'):
    # tld = ".science"
    # for filename in ('data/cdx/cdx-00278.gz',):
